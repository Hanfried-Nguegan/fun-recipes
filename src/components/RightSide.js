  ...
  return (
    <section className="split right bg-pinkychoco">
      <div className="absolute inset-y-0 right-0 w-28 flex items-center justify-center">
        <ArrowForwardIcon className="absolute z-50 bg-[#635dad] rounded-l-full w-[50px] hover:w-[55px] transition-all duration-500 h-[40px] p-[8px] top-1/2 right-0 transform -translate-y-1/2 text-white cursor-pointer" />
      </div>
      <Donut />
      <TextRight />
      <ArrowImageRight />
